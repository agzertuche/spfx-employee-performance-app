...
//     return this.webPartContext.httpClient
//       .get(
...
//     return this.clientApplication.acquireTokenSilent(msalconfig.scopes).then(
//       (token: string) => {
...
//         if (error) {
//           this.clientApplication.acquireTokenPopup(msalconfig.scopes).then(
//             (token: string) => {
//               return this._getUsers(token);
//             },
//             (err: string) => {
...
//     const promises = users.map(u => {
//       const ei = employeesInformation.find(
//         x =>
//           x.fields.userPrincipalName.toUpperCase() ===
//           u.userPrincipalName.toUpperCase()
//       );
...
//     const groupedAchievements = this.groupByArray(
//       this.earnedAchievements,
//       'achievementId'
//     ).sort((a, b) => {
...
//     const userAchievements = this.groupByArray(
//       this.earnedAchievements,
//       'userPrincipalName'
//     ).sort((a, b) => {
//       return b.values.length - a.values.length;
